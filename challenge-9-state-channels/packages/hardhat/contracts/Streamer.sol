...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        ...
        */
        require(balances[msg.sender] == 0, "A running channel exists");
    ...
    function withdrawEarnings(Voucher calldata voucher) public onlyOwner {
        ...
        bytes32 hashed = keccak256(abi.encodePacked(voucher.updatedBalance));
        ...
        */
        ...
        require(sent, "Payment sending failed");
    ...
    */
    ...
    function challengeChannel() public {
        require(balances[msg.sender] > 0, "Channel isn't open");
